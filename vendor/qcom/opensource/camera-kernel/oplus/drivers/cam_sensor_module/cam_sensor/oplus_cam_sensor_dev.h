...
#define GC16B3_SENSOR_ID        0x16b3
#define GC02M1B_TACOOF_SENSOR_ID      0x02
...
struct cam_sensor_settings {
	...
	struct cam_sensor_i2c_reg_setting_array gc16b3_setting;
	struct cam_sensor_i2c_reg_setting_array gc02m1b_tacoof_setting;
	struct cam_sensor_i2c_reg_setting_array sc520cs_setting;
...
struct cam_sensor_init_settings {
	...
	struct cam_sensor_i2c_reg_init_array s5kjnssq33_setting;
	struct cam_sensor_i2c_reg_init_array sc520cs_setting;
	struct cam_sensor_i2c_reg_init_array ov08d10_setting;
	struct cam_sensor_i2c_reg_init_array sy_gc02m1b_setting;
	struct cam_sensor_i2c_reg_init_array imx882_setting;
	struct cam_sensor_i2c_reg_init_array gc16b3_setting;
	struct cam_sensor_i2c_reg_init_array gc02m1b_tacoof_setting;
	struct cam_sensor_i2c_reg_init_array ov02b10_setting;
	struct cam_sensor_i2c_reg_init_array imx355_setting;
	struct cam_sensor_i2c_reg_init_array gc32e2_setting;
};
