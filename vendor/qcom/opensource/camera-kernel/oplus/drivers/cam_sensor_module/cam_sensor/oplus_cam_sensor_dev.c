...
int sensor_start_thread(void *arg) {
    ...
    if (rc == 0) {
        ...
        if (s_ctrl->sensor_initsetting_state == CAM_SENSOR_SETTING_WRITE_INVALID){
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == IMX882_SENSOR_ID)
            {
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == GC16B3_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.gc16b3_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_BYTE;
                sensor_init_setting.size        = sensor_init_settings.gc16b3_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.gc16b3_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == GC02M1B_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.gc02m1b_tacoof_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_BYTE;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_BYTE;
                sensor_init_setting.size        = sensor_init_settings.gc02m1b_tacoof_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.gc02m1b_tacoof_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == SC520CS_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.sc520cs_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_BYTE;
                sensor_init_setting.size        = sensor_init_settings.sc520cs_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.sc520cs_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == S5KJNSSQ33_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.s5kjnssq33_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.size        = sensor_init_settings.s5kjnssq33_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.s5kjnssq33_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == OV08D10_SENSOR_ID)
            {
            ...
            {
                sensor_init_setting.reg_setting = sensor_init_settings.sy_gc02m1b_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.size        = sensor_init_settings.sy_gc02m1b_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.sy_gc02m1b_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == OV02B10_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.ov02b10_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.size        = sensor_init_settings.ov02b10_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.ov02b10_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == IMX355_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.imx355_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.size        = sensor_init_settings.imx355_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.imx355_setting.delay;
            ...
            else if (s_ctrl->sensordata->slave_info.sensor_id == GC32E2_SENSOR_ID)
            {
                sensor_init_setting.reg_setting = sensor_init_settings.gc32e2_setting.reg_setting;
                sensor_init_setting.addr_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.data_type   = CAMERA_SENSOR_I2C_TYPE_WORD;
                sensor_init_setting.size        = sensor_init_settings.gc32e2_setting.size;
                sensor_init_setting.delay       = sensor_init_settings.gc32e2_setting.delay;
        ...
        case VIDIOC_CAM_FTM_POWNER_UP:
            ...
            switch(s_ctrl->sensordata->slave_info.sensor_id)
            {
                ...
                case IMX882_SENSOR_ID:
                    ...
                    break;
                case GC16B3_SENSOR_ID:
                    ptr = &sensor_settings.gc16b3_setting;
                    break;
                case GC02M1B_TACOOF_SENSOR_ID:
                    ptr = &sensor_settings.gc02m1b_tacoof_setting;
                    break;
                case SC520CS_SENSOR_ID:
                    ptr = &sensor_settings.sc520cs_setting;
                    break;
